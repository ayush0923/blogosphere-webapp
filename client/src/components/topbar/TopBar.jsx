    ...
    <div className="top">
      ...
      <div className="topCenter">
        <ul className="topList">
          ...
          <li className="topListItem">
            <Link className="link abc" to="/contact">
              CONTACT
            </Link>
          </li>
          <li className="topListItem">
      ...
      <div className="topRight">
        {user ? (
          <Link to="/settings">
            <img className="topImg" src={user.profilePic ? PF + user.profilePic : img} alt="" />
          </Link>
        ) : (
          <ul className="topList">
            <li className="topListItem">
